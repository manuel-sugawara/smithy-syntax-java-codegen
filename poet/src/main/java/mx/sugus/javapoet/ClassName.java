...
public final class ClassName extends TypeName implements Comparable<ClassName> {
    ...
    /**
     * Returns a new {@link ClassName} instance for the given fully-qualified class name string. This method assumes that the
     * input is ASCII and follows typical Java style (lowercase package names, UpperCamelCase class names) and may produce
     * incorrect results or throw {@link IllegalArgumentException} otherwise. For that reason, {@link #get(Class)} and
     * {@link #get(Class)} should be preferred as they can correctly create {@link ClassName} instances without such
     * restrictions.
     */
    ...
    /**
     * Returns a class name created from the given parts. For example, calling this with package name {@code "java.util"} and
     * simple names {@code "Map"}, {@code "Entry"} yields {@link Map.Entry}.
     */
    ...
    /**
     * Returns the package name, like {@code "java.util"} for {@code Map.Entry}. Returns the empty string for the default
     * package.
     */
    ...
    /**
     * Returns the enclosing class, like {@link Map} for {@code Map.Entry}. Returns null if this class is not nested in another
     * class.
     */
    ...
    /**
     * Returns the top class in this nesting group. Equivalent to chained calls to {@link #enclosingClassName()} until the
     * result's enclosing class is null.
     */
    ...
    /**
     * Returns a class that shares the same enclosing package or class. If this class is enclosed by another class, this is
     * equivalent to {@code enclosingClassName().nestedClass(name)}. Otherwise it is equivalent to
