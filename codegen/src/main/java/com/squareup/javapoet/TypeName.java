...
/**
 * Any type in Java's type system, plus {@code void}. This class is an identifier for primitive types like {@code int} and raw
 * reference types like {@code String} and {@code List}. It also identifies composite types like {@code char[]} and
 * {@code Set<Long>}.
 *
 * <p>Type names are dumb identifiers only and do not model the values they name. For example, the
 * type name for {@code java.util.List} doesn't know about the {@code size()} method, the fact that lists are collections, or even
 * that it accepts a single type parameter.
 *
 ...
 * ClassName#get(String, String, String...)}. To build composite types like {@code char[]} and {@code Set<Long>}, use the factory
 * methods on {@link ArrayTypeName}, {@link ParameterizedTypeName}, {@link TypeVariableName}, and {@link WildcardTypeName}.
 */
public class TypeName {
    ...
    /**
     * Returns true if this is a primitive type like {@code int}. Returns false for all other types types including boxed
    ...
    /**
     * Returns true if this is a boxed primitive type like {@code Integer}. Returns false for all other types types including
     * unboxed primitives and {@code java.lang.Void}.
     */
    ...
    /**
     * Returns a boxed type if this is a primitive type (like {@code Integer} for {@code int}) or {@code void}. Returns this type
     * if boxing doesn't apply.
     */
    public TypeName box() {
        if (keyword == null) {
    ...
    /**
     * Returns an unboxed type if this is a boxed primitive type (like {@code int} for {@code Integer}) or {@code Void}. Returns
     * this type if it is already unboxed.
     *
